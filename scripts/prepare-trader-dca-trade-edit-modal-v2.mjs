        ...
        <section className={styles.dcaTradeEditModal} role="dialog" aria-modal="true" aria-label="Edit active DCA trade">
          ...
          <div className={styles.dcaTradeEditScroll}>
            ...
            <section className={styles.dcaTradeEditSection}>
              ...
              <div className={styles.dcaTradeToggleRow}><strong>Trailing</strong><button type="button" className={dcaTradeEditDraft.trailingEnabled ? styles.toggle + " " + styles.toggleOn : styles.toggle} onClick={() => setDcaTradeEditDraft((current) => ({ ...current, trailingEnabled: !current.trailingEnabled }))}><i/></button></div>
            ...
            <section className={styles.dcaTradeEditSectionCompact}>
              <div className={styles.dcaTradeToggleRow}><strong>Stop Loss</strong><button type="button" className={dcaTradeEditDraft.stopEnabled ? styles.toggle + " " + styles.toggleOn : styles.toggle} onClick={() => setDcaTradeEditDraft((current) => ({ ...current, stopEnabled: !current.stopEnabled }))}><i/></button></div>
            ...
            <section className={styles.dcaTradeEditSectionCompact}>
              <div className={styles.dcaTradeToggleRow}><strong>Maximum hold period</strong><button type="button" className={dcaTradeEditDraft.maxHoldEnabled ? styles.toggle + " " + styles.toggleOn : styles.toggle} onClick={() => setDcaTradeEditDraft((current) => ({ ...current, maxHoldEnabled: !current.maxHoldEnabled }))}><i/></button></div>
