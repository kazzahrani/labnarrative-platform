...
if (!source.includes("TRADER_CHART_VIEWPORT_STABILITY_V1")) {
  ...
  required(
    ...
    "viewport restore block",
  );

  required(
    '  }, [candles, interval, enabled, paneOrder, paneHeights, priceHeight, autoY, conditions, structureSignature, canvasHeight]);',
    '  }, [accountId, tradeId, candles, interval, enabled, paneOrder, paneHeights, priceHeight, autoY, conditions, structureSignature, canvasHeight]);',
    "chart effect dependencies",
  );
}
