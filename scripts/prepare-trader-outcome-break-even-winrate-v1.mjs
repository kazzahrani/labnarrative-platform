...
console.log("Added theoretical current-plan and historical realized-payoff break-even win rates with distinct ring markers to the DCA Outcome Mix popup.");
