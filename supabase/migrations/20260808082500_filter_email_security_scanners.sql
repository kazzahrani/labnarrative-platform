-- Keep raw browser activity for diagnostics, but prevent immediate institutional
-- email-security crawling from being treated as PI sales engagement.
...
engaged_sessions_after_cooldown as (
  ...
  join first_outreach o
   ...
   and e.created_at >= o.first_outreach_at + interval '2 minutes'
...
comment on view public.sales_concept_summary is
  'Sales analytics summary. Headline visits require engagement at least two minutes after real outreach and exclude rapid multi-session/multi-page bursts characteristic of email-security scanners. Raw page loads remain available only as diagnostics.';
