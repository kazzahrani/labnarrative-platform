...
export function timeframeMs(tf:string){return ({"1 minute":60000,"3 minutes":180000,"5 minutes":300000,"15 minutes":900000,"30 minutes":1800000,"1 hour":3600000,"2 hours":7200000,"4 hours":14400000,"6 hours":21600000,"8 hours":28800000,"12 hours":43200000,"1 day":86400000,"3 days":259200000,"1 week":604800000,"1 month":2592000000} as Record<string,number>)[tf]??300000;}
function binanceInterval(tf:string){return ({"1 minute":"1m","3 minutes":"3m","5 minutes":"5m","15 minutes":"15m","30 minutes":"30m","1 hour":"1h","2 hours":"2h","4 hours":"4h","6 hours":"6h","8 hours":"8h","12 hours":"12h","1 day":"1d","3 days":"3d","1 week":"1w","1 month":"1M"} as Record<string,string>)[tf]??"5m";}
function bybitInterval(tf:string){return ({"1 minute":"1","3 minutes":"3","5 minutes":"5","15 minutes":"15","30 minutes":"30","1 hour":"60","2 hours":"120","4 hours":"240","6 hours":"360","12 hours":"720","1 day":"D","1 week":"W","1 month":"M"} as Record<string,string>)[tf]??"5";}
function okxInterval(tf:string){return ({"1 minute":"1m","3 minutes":"3m","5 minutes":"5m","15 minutes":"15m","30 minutes":"30m","1 hour":"1H","2 hours":"2H","4 hours":"4H","6 hours":"6H","12 hours":"12H","1 day":"1D","3 days":"3D","1 week":"1W","1 month":"1M"} as Record<string,string>)[tf]??"5m";}
function kucoinInterval(tf:string){return ({"1 minute":"1min","3 minutes":"3min","5 minutes":"5min","15 minutes":"15min","30 minutes":"30min","1 hour":"1hour","2 hours":"2hour","4 hours":"4hour","6 hours":"6hour","8 hours":"8hour","12 hours":"12hour","1 day":"1day","1 week":"1week","1 month":"1month"} as Record<string,string>)[tf]??"5min";}
...
export async function closedCandles(provider:LaunchExchangeProvider,pairInput:string,tf:string,limit=320):Promise<ClosedCandle[]>{
  const pair=pairValue(pairInput),duration=timeframeMs(tf),now=Date.now();
  if(provider==="binance"){
