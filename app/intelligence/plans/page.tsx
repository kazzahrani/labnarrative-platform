  ...
  return (
    <main className={`${brand.page} ${styles.page}`}>
      <header className={brand.header}>
        ...
        <a className={brand.cta} href="mailto:hello@labnarrative.com?subject=Complimentary%20LabNarrative%20product%20experience">Start free ↗</a>
      </header>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.heroCopy}>
          Every company can experience the complete LabNarrative workflow on one real product for free. Choose a subscription only when you want continuous monitoring across more of your portfolio.
        </p>
      </section>
