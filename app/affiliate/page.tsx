...
export const metadata: Metadata = {
  ...
  description: "Create useful LabNarrative content to earn free Max, unlock performance bonuses as your content grows, and earn 40% cash commission on qualifying Pro, Max and Performance payments.",
};
...
const steps = [
  ...
  ["04", "Convert customers", "Earn 40% of qualifying Pro, Max and paid Performance settlements. Referral Max rewards stack too."],
];
...
const terms = [
  ...
  "Affiliates earn 40% of every qualifying payment actually collected: Pro, Max, and non-zero Performance settlements. A $0 Performance month pays $0 commission. Every new paying customer adds Max access after their first qualifying payment; for Performance, that means the first non-zero settlement actually paid. Each 10-customer milestone receives the 2-month bonus needed to make 10 paying customers = 1 full year of Max.",
...
export default function AffiliatePage() {
  return <main className={styles.page}>
    ...
    <section className={styles.affiliateHero}><div className={styles.affiliateHeroInner}><div><p className={styles.eyebrow}>Creator + Affiliate Program</p><h1>Create. Grow.<br /><em>Earn.</em></h1><p className={styles.affiliateLead}><strong>Create useful content → earn Max.</strong> Grow your views → earn more Max. Refer paying customers → earn <strong>40% cash commission</strong>.</p><div className={styles.heroActions}><a className={styles.primary} href={AFFILIATE_URL}>Open Creator & Affiliate dashboard →</a><a className={styles.secondary} href="#creator-rewards">See content rewards</a></div></div><aside className={styles.commissionPanel}><small>Three ways to earn</small><strong>40%</strong><p>Cash commission on qualifying Pro, Max and Performance payments, plus Max rewards for approved content and performance.</p><div className={affiliateStyles.commissionStats}><div><span>Content package</span><b>1 month</b><small>Max free</small></div><div><span>Affiliate sale</span><b>40%</b><small>cash commission</small></div></div></aside></div></section>
    ...
    <section className={styles.section}><div className={styles.sectionIntro}><p className={styles.label}>Layer 3 · Results</p><h2>Turn the audience into customers.</h2></div><div className={styles.programGrid}><article><span>01</span><h3>40% cash commission</h3><p>Earn 40% of every qualifying payment attributed to your affiliate link — including paid Performance settlements. A $78 Performance settlement pays $31.20 commission.</p></article><article><span>02</span><h3>+1 Max month per customer</h3><p>Every new paying customer creates one Max reward after their first qualifying payment. For Performance, the first non-zero paid settlement counts; enrollment and $0 months do not. Later payments continue to earn 40% cash commission.</p></article><article><span>10</span><h3>10 customers = 1 Max year</h3><p>Every 10th valid paying customer adds the 2-month milestone bonus, making each block of 10 worth 12 Max months.</p></article></div></section>
