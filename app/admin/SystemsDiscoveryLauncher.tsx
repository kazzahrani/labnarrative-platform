...
export default function SystemsDiscoveryLauncher(){
  ...
  const href=isGroup?"/admin/systems-outreach/discovery":isCommercial?"/admin/systems-outreach/discovery/group":isPilot?"/admin/systems-outreach/discovery/commercial":isBuilder?"/admin/systems-outreach/discovery/pilot":isDiscovery?"/admin/systems-outreach/discovery/demo-v2":"/admin/systems-outreach/discovery";
  const label=isGroup?"Discovery Workspace":isCommercial?"Group Architecture":isPilot?"Pricing Architecture":isBuilder?"Pilot Proposal Builder":isDiscovery?"Demo V2 Builder":"Discovery Workspace";
  const icon=isCommercial?"▦":isPilot?"◇":isBuilder?"▤":isDiscovery&&!isGroup?"✦":"◆";
