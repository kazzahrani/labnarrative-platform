...
export default function SystemsDiscoveryLauncher(){
  ...
  const href=isDelivery?"/admin/systems-outreach/discovery":isGroup?"/admin/systems-outreach/delivery":isCommercial?"/admin/systems-outreach/discovery/group":isPilot?"/admin/systems-outreach/discovery/commercial":isBuilder?"/admin/systems-outreach/discovery/pilot":isDiscovery?"/admin/systems-outreach/discovery/demo-v2":"/admin/systems-outreach/discovery";
  const label=isDelivery?"Discovery Workspace":isGroup?"Pilot Delivery":isCommercial?"Group Architecture":isPilot?"Pricing Architecture":isBuilder?"Pilot Proposal Builder":isDiscovery?"Demo V2 Builder":"Discovery Workspace";
  const icon=isGroup?"✓":isCommercial?"▦":isPilot?"◇":isBuilder?"▤":isDiscovery&&!isDelivery?"✦":"◆";
