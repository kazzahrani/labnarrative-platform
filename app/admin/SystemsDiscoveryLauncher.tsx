...
export default function SystemsDiscoveryLauncher(){
  ...
  const href=isCommercial?"/admin/systems-outreach/discovery":isPilot?"/admin/systems-outreach/discovery/commercial":isBuilder?"/admin/systems-outreach/discovery/pilot":isDiscovery?"/admin/systems-outreach/discovery/demo-v2":"/admin/systems-outreach/discovery";
  const label=isCommercial?"Discovery Workspace":isPilot?"Pricing Architecture":isBuilder?"Pilot Proposal Builder":isDiscovery?"Demo V2 Builder":"Discovery Workspace";
  const icon=isPilot?"◇":isBuilder?"▤":isDiscovery&&!isCommercial?"✦":"◆";
