...
export default function SiteShell({ site, route, basePath, previewMode = false, isLive = false }: { site: LabSite; route: SiteRoute; basePath?: string; previewMode?: boolean; isLive?: boolean }) {
  ...
  if (designVariant === PORTRAIT_MINIMAL_1_VARIANT) {
    ...
    return <PortraitMinimal1Design site={site} route={route} basePath={resolvedBasePath} previewMode={previewMode} />;
  }
  ...
  if (designVariant === NARITA_3_VARIANT) {
    ...
    return <Narita3Design site={site} route={route} basePath={resolvedBasePath} previewMode={previewMode} />;
  }
